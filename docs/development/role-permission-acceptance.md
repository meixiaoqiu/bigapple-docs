...
| 财务审核员任命 | 有权成员提名、执衡者表决、执行后仅获得审核及所需私有材料查看权限。 | `core.tests.test_finance_role_appointments` |
| 财务审核职责分离 | 可以审核他人待审核报销；不得自审，且不自动取得付款或公开附件发布权限。 | `core.tests.test_finance_role_appointments.FinanceReviewerEndToEndTests` |
